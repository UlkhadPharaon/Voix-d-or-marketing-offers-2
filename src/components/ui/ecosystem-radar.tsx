...
export function EcosystemRadar() {
  return (
    <div className="relative flex min-h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-[8px] bg-white/[0.03] backdrop-blur-md border border-white/10 shadow-[0_8px_32px_rgba(212,175,55,0.05)] mt-12 mb-20 py-10">
      <div className="z-50 text-center px-4 mb-4 md:mb-8">
        <h3 className="text-[18px] sm:text-[22px] font-heading uppercase tracking-[1px] text-white">Le Radar de L'Employé Virtuel</h3>
        <p className="text-[14px] text-gray-text mt-2 max-w-2xl mx-auto">Une surveillance continue à 360° de votre écosystème commercial.</p>
      </div>
      ...
      <div className="mx-auto my-8 md:my-12 w-full max-w-md px-2 md:px-4 relative z-50">
        <div className="flex w-full items-center justify-center space-x-4 sm:space-x-10 md:justify-between md:space-x-0">
          ...
          <div className="relative z-50 flex h-16 w-16 md:h-20 md:w-20 items-center justify-center rounded-full border border-primary/50 bg-black/40 backdrop-blur-xl shadow-[0_0_40px_rgba(212,175,55,0.3)]">
