  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="animate-radar-spin absolute right-1/2 top-1/2 z-40 flex h-[5px] w-[150px] sm:w-[250px] md:w-[400px] items-end justify-center overflow-hidden bg-background/0"
      >
