...
export const IconContainer = ({
  ...
  return (
    ...
    >
      <div className="shrink-0 flex h-14 w-14 items-center justify-center rounded-2xl border border-white/10 bg-[#121212] shadow-[inset_0_0_20px_rgba(212,175,55,0.05)]">
        {icon || (
