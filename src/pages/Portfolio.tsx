  ...
  return (
    <PageTransition className="min-h-screen bg-background/0 text-foreground pt-[100px] md:pt-[120px] pb-12 md:pb-24 border-t border-primary/20">
      <SEO 
        ...
        description="Découvrez nos réalisations vidéos conçues et gérées par nos assistants IA pour différentes marques : gastronomie, supermarché, retail, parfumerie. La qualité d'une agence internationale, ici au Burkina."
      />
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-16 flex flex-col items-center">
          ...
          <h1 className="text-[28px] sm:text-[40px] md:text-[48px] font-heading font-normal mb-[16px] uppercase tracking-[1px] leading-tight">
            Ce que "professionnel" <span className="text-primary italic font-serif">veut dire</span> pour nos Assistants IA
          </h1>
        ...
        >
          ...
          <div className="mt-8 flex flex-col items-center">
            <h3 className="text-[24px] sm:text-[32px] font-heading font-normal mb-8 uppercase tracking-[1px] text-center text-foreground">Vous voulez voir l'assistant IA générer vos vidéos ?</h3>
