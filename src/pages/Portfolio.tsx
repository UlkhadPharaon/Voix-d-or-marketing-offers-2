      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="mt-8 flex flex-col items-center">
            <h3 className="text-[24px] sm:text-[32px] font-heading font-normal mb-8 uppercase tracking-[1px] text-center text-foreground">Vous voulez voir l'employé virtuel générer vos vidéos ?</h3>
